...
** Поместите в Table (Таблицу) «раздражающие» переменные и связанные с ними притоки и оттоки. Установите интервал печати таблицы в DT (delta time - интервал времени). Установите Таблицу так, чтобы она выдала начальные балансы.
