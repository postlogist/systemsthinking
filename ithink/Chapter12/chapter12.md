...
### Подход "ключевых актеров"

Часто, размышляя об «актерах», связанных с вашей моделью, вы можете идентифицировать ядро основных запасов и соответствующих им потоков.

* Определите наименьший набор Ключевых Актеров, которых вы предполагаете привлечь для участия в создании шаблона эталонного поведения. Актеры часто не являются отдельными людьми.

* Для каждого актера определите условия, которые он контролирует вещи внутри определенной части системы. Условия могут быть материальными (например, деньги) или нематериальными (например, доверие). Скорее всего, они будут представлены в виде *запасов*.

* Затем определите действия, предпринимаемые каждым актером в ответ на изменения условий. Действия будут представлены *потоками*.
...
* Полезно использовать «Матрицу ключевых актеров» (см. рисунок 12-6) для сбора информации об условиях, действиях и ресурсах.
...
#### *Инструкция 5: Преобразуйте вашу карту в компьютерную модель, включая уравнения*

После того, как вы вычленили карту, выберите из нее кусок (сектор - хороший кусок) и сделайте его имитационным, т.е. приведите соответствующую математику и включите числа.
