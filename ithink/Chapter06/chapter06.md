...
Процесс именуется истощением багодаря принципу действия, он не компенсируется новыми притоками. В таком контексте процесс истощения демонстрирует *отток ресурсов* На рисунке 6.3А показан случай, когда «доля истощения» или «время истощения» постоянны.
