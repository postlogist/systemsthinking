...
В примере с «прямой» связью новые клиенты привлекаются благодаря старым при помощи *коэффициента эффективности устной рекламы*. В случае с «расширеной» связью всё зависит от объема невыполненной в срок работы - ее рост/сокращение влияет на количество часов, выделенных на работу (уровень *второго* запаса). Увеличение/сокращение часов работы вызывает увеличение/сокращение скорости выполнения работы, тем самым приводя всю систему в равновесие и компенсируя просроченную работу.
