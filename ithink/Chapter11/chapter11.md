...
Внедрение в этом случае проходило двумя путями. Команда старшего руководства хотела получить для своих организаций инструмент обучения и связанные с ним упражнения. Учитывая, что «обучающее событие» было коротким и четко определенным, его относительно легко воспроизвести. Кроме того, по моему убеждению, прогрессирование моделей было сохранено для целей «организационного обучения». Можно сказать, что настоящее организационное обучение (по отношению к проблеме) происходит только в том случае, если соответствующие понимание и интуиция как бы отделяются, а затем *независимо* содержатся в человеческих ресурсах, которыми обладает организация в определённый момент времени. Прогрессирование моделей «относительного расширения» и связанных с ними упражнений соответствовало этим критериям. Они стали первым основополагающим вкладом в инфраструктуру организационного обучения фирмы.
