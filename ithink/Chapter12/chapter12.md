...
Не включайте более 20 периодов решения (оптимально 10-15). Используйте функцию Run/Restore (Прогон/Возврат), а не Run для кнопок Run, чтобы не допустить случайного прогона после окончания симуляции и непреднамеренного уничтожения отчёта о решениях и достижениях в производительности. Подумайте о включении эскизного графа Sketchable, чтобы дать обучащимся возможность «оставлять зарубки» в отношении результатов работы, которых они надеются достичь.
