...
#### *Инструкция 2: Обеспечетьте стабильности модели в стационарном режиме*
...
* Поместите раздражающий запас (или запасы), притоки и оттоки в таблицу. Решить проблему. Повторяйте, пока модель не установится.
