...
Во второй части рисунка добавляется препятствующий цикл. Точкой соприкосновения двух циклов является «коэффициент эффективности устной рекламы». Теперь это уже не константа, а переменная, которая зависит от насыщения рынка (сегментации). Уравнение коэффициента имеет следующий вид: базисный коэффициент эффективности * степень насыщенности рынка
