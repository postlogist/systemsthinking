...
Прежде чем мы продолжим рассматривать ссылки для создания циклов обратной связи с участием *нескольких* предложений, давайте посмотрим, какое характерное изобилие мы можем вызвать, позволяя изменять параметры в *прямой* структуре цикла обратной связи. На рисунке 6-1А изображен простой усиливающий цикл обратной связи (как показано на рисунке 6-1 с буквой «R»). Как было описано в 5 главе, если оставить цикл действовать самостоятельно, это приведет к тому, что *Инфицированное население* будет всегда расти экспоненциально.
