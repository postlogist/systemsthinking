...
Таким образом, когда поток товаров из производства снова становится равным потоку продаж (это условие необходимо для достижения равновесного состояния), уровень запаса оказывается максимально удаленным от своего равновесного состояния. В управлении системой есть серьезные проблемы! Входящий и выходящий потоки накопителя находятся в равновесии именно в тот момент, когда уровень в данном накопителе максимально отклоняется от своего равновесного значения. Именно при этом условии в системе возникают незатухающие циклические колебания.
