...
1. Сделайте параметры *ср. время для привлечения клиента*, *время на принятия решения о покупке*, *доля тех, кто делает покупки*, *доля потерявших интерес (угасание активности)* зависимыми от таких вещей, как реклама, нацеленные почтовые рассылки, открытие шоурумов, качество продукта и клиентского сервиса.

2. Добавьте новые категории клиентов. К примеру, разделите *Активных клиентов* на *Новых* и *Ключевых*
...
1. Модифицируйте каскад для того, чтобы он был ориентирован на ключевые процессы вашей системы.

2. Добавьте вспомогательную структуру (ознакомитесь в Главе 9) для обеспечения наглядности возможных ограничений ресурсов.

3. Добавьте параметр *длительность цикла* для совершенствования и улучшения процесса моделирования (ознакомьтесь с папкой *Help Files* в программе *ithink* для того, чтобы узнать больше о данном параметре)

4. Установите ограничения на входящий поток и мощность Конвейеров (пропускная способность). Добавьте Очереди перед Конвейерами, чтобы создать условия «превышения пропускной способности».

5. Сделайте время прохождения Конвейеров переменным параметром, а не константным.

6. Сделайте параметр утечки Конвейеров зависимым от условий внутри системы
